...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <case_> case
    %type <cases> nonempty_case_list
    %type <expression> expression opt_init let_binding
    %type <expressions> expression_list nonempty_expression_comma_list nonempty_expression_semicolon_list
    ...
    */
    ...
    | LET let_binding
    { $$ = $2; }
    | CASE expression OF nonempty_case_list ESAC
    { $$ = typcase($2, $4); }
    | NEW TYPEID
    { $$ = new_($2); }
    | ISVOID expression
